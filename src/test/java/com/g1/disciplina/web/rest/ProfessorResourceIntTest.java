...
import com.g1.disciplina.repository.ProfessorRepository;
...
public class ProfessorResourceIntTest {
    ...
    private static final Long DEFAULT_SIAPE = 1L;
    private static final Long UPDATED_SIAPE = 2L;
    ...
    public void getAllProfessors() throws Exception {
        ...
        restProfessorMockMvc.perform(get("/api/professors?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].siape").value(hasItem(DEFAULT_SIAPE.intValue())));
    }
    ...
    public void getProfessor() throws Exception {
        ...
        restProfessorMockMvc.perform(get("/api/professors/{id}", professor.getId()))
            ...
            .andExpect(jsonPath("$.siape").value(DEFAULT_SIAPE.intValue()));
    }
